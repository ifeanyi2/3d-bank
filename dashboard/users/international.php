    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-12 col-lg-3 col-md-6">
                <a href="md.php" class="btn btn-primary"><i class="fa fa-refresh"></i> Mobile Deposit</a>
            </div>
            <div class="col-12 col-lg-3 col-md-6">
        ...
        <?php echo $_SESSION['acctno'] ?> &nbsp;| &nbsp;$<?php echo number_format($row['balance']); ?>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label class="login2 pull-right pull-right-pro">Beneficiary</label>
                                                        </div>
                                                        <div class="col-lg-6">
                                                    ...
                                                    <div class="login-btn-inner">
                                                        <div class="row text-center">
                                                            <div class="col-lg-12">
                                                                    ...
                                                                    <button class="btn btn-primary login-submit-cs" name="transfer" type="submit">Transfer</button>
