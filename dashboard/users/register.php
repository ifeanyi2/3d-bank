...
$sql1 = "INSERT INTO tbl_users (fname, lname,username, pwd, email, phone, gender, is_mobile, mobile_hash, utype, pics, bdate,acctno,active,status,pin,session,balance,address,city,state,zipcode,notification,nbalance,inbalance,bname,country,ipn,imf,cot)

        VALUES ('$fname', '$lname','$username', '$pwd', '$email', '$phone', '$gender', '$is_mobile','$mobile_hash', '$utype', '$image', '$bdate','$account','$active','$status','$pin','$session','$balance','$address','$city','$state','$zipcode','$notification','$nbalance','$inbalance','$bname','$country','$ipn','$imf','$cot')";
...
<body>
<div class="image-container set-full-height" style="background-image:linear-gradient(60deg, rgba(2,5,50,0), rgba(5,10,100,1)), url('reg/img/bg.jpg');">
                    ...
                    <form action="register.php" method="post" enctype="multipart/form-data" >
                    	...
                    	<div class="wizard-header">
                        	<h3>
                        	   ...
                        	   <small>Please register your account with us to take the benefits of our Online Banking facilities.</small>
                        	</h3>
                    	</div>
                        </br>
...
<input name="inbalance" type="hidden" class="form-control" value="Incoming Balance">
 <input name="bname" type="hidden" class="form-control" value="Bank Name">
                        ...
                        <div class="wizard-footer height-wizard mb-3">
                    ...
                    <br><br>
                     <div style="margin-left:10%"><a href="../../"><button style="width:40%" class="btn btn-primary">Back To Home</button></a> &nbsp;&nbsp; <a href="index.php"><button style="width:20%" class="btn btn-primary">Login</button></a></div>
                </div>
