...
<div class="move">
            ...
            <a href="home.php" class="btn btn-lg btn-success mt-5"><i class="fa fa-university"></i> Home</a>
            </div>
                    ...
                    <form action="new.php" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="about">
                              <div class="row">
                                  <h4 class="info-text ml-4"> Let's start with the basic information </h4>
                                    ...
                                    <div class="col-sm-6 ml-5">
                                         <div class="form-group">
                                            <label>Gender</label><br>
                                             <select required name="gender" class="form-control" style="height:40px">
                                    ...
                                    <div class="col-sm-6 ml-5">
                                         <div class="form-group">
                                            <label> Account Type</label><br>
                                             <select required name="utype" class="form-control" style="height:40px">
