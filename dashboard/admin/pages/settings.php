...
if(isset($_POST['uset'])){
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1><i class="fa fa-home " style="font-size:30px"></i> BANK CONFIGURATION</h1>
 ...
 <div class="form-group">
     ...
     <div class="form-group">
        <input type="text" name="apipr" placeholder="sms sid" value="<?php echo $sms_private_key;?>"  class="form-control">
        </div>

        <div class="form-group">
        <input type="text" name="apipu" placeholder="sms token" value="<?php echo $sms_public_key;?>"  class="form-control">
        </div>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
        <input type="text" name="branch" placeholder="branch" value="<?php echo $branch;?>"  class="form-control">
        </div>
