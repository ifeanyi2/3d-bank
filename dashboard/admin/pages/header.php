        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="log-out.php"><i class="fa fa-user"></i> <span>Log-Out</span></a></li>
               ...
               <li><a class="nav-link" href="inmessage.php?email=<?php echo $em ;?>"><i class="fa fa-user"></i> <span>News Management</span></a></li>

              <li >
                <a href="card.php" class="nav-link "><i class="fas fa-th"></i> <span>Card Management</span></a>
                
              </li>
              
              
                 <li >
                <a href="loan.php" class="nav-link "><i class="fas fa-th"></i> <span>Loan Management</span></a>
                
              </li>
              
              
               <li >
                <a href="md.php" class="nav-link "><i class="fas fa-th"></i> <span>Mobile-Deposit</span></a>
...
<li >
              ...
              <li><a class="nav-link" href="credit.php"><i class="fas fa-pencil-ruler"></i> <span>Transactions</span></a></li>
